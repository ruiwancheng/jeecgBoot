...
export const searchFormSchema: FormSchema[] = [
  { field: 'code', label: '单号', component: 'Input', colProps: { span: 6 }, componentProps: { maxlength: 50 } },
  {
    ...
    colProps: { span: 6 },
    componentProps: { dictCode: 'mes_other_stock_out_type' },
  },
...
export const formSchema: FormSchema[] = [
  { field: 'id', label: 'id', component: 'Input', show: false },
  {
    ...
    required: true,
    colProps: { span: 8 },
    componentProps: { maxlength: 50, placeholder: 'QT-OUT-YYYYMMDD-0001' },
  },
  {
    field: 'outType',
    label: '出库类型',
  ...
  { field: 'stockDate', label: '出库日期', component: 'DatePicker', colProps: { span: 8 }, componentProps: { valueFormat: 'YYYY-MM-DD' } },
  {
    ...
    colProps: { span: 24 },
    componentProps: { maxlength: 500, placeholder: '手工填写出库原因' },
  },
  {
    field: 'status',
    label: '状态',
