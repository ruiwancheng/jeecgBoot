...
export const columns: BasicColumn[] = [
  ...
  { title: '适用单据', dataIndex: 'bizType_dictText', width: 110 },
...
export const searchFormSchema: FormSchema[] = [
  ...
  { field: 'bizType', label: '适用单据', component: 'JDictSelectTag', colProps: { span: 6 }, componentProps: { dictCode: 'mes_code_biz_type' } },
];
...
export const formSchema: FormSchema[] = [
  ...
  { field: 'bizType', label: '适用单据', component: 'JDictSelectTag', required: true, colProps: { span: 12 }, componentProps: { dictCode: 'mes_code_biz_type', placeholder: '请选择该规则用于哪个单据' } },
