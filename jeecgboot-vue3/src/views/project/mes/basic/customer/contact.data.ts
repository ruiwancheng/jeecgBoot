...
export const contactColumns: BasicColumn[] = [
  ...
  { title: '默认', dataIndex: 'isDefault', width: 60, customRender: ({ value }) => (value === 1 ? '是' : '') },
...
export const contactFormSchema: FormSchema[] = [
  ...
  { field: 'isDefault', label: '是否默认', component: 'Switch', colProps: { span: 12 }, defaultValue: 0, componentProps: { checkedValue: 1, unCheckedValue: 0 } },
