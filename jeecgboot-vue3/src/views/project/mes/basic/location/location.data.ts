...
export const formSchema: FormSchema[] = [
  ...
  { field: 'loadCapacity', label: '承重(kg)', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'storageLimit', label: '存放限制', component: 'Input', colProps: { span: 8 } },
...
export const zoneFormSchema: FormSchema[] = [
  { field: 'id', label: 'id', component: 'Input', show: false },
  { field: 'warehouseId', label: '所属仓库', component: 'Input', show: false },
  { field: 'code', label: '库区编码', component: 'Input', required: true, colProps: { span: 12 } },
  { field: 'name', label: '库区名称', component: 'Input', colProps: { span: 12 } },
  { field: 'sortNo', label: '排序号', component: 'InputNumber', colProps: { span: 12 }, defaultValue: 0 },
  { field: 'status', label: '状态', component: 'JDictSelectTag', colProps: { span: 12 }, componentProps: { dictCode: 'yn', type: 'radioButton', stringToNumber: true }, defaultValue: 1 },
  { field: 'remark', label: '备注', component: 'InputTextArea', colProps: { span: 24 } },
];
...
export const shelfFormSchema: FormSchema[] = [
  ...
  { field: 'zoneId', label: '所属库区', component: 'Input', show: false },
  { field: 'warehouseId', label: '所属仓库', component: 'Input', show: false },
  { field: 'code', label: '货架编码', component: 'Input', required: true, colProps: { span: 12 } },
  { field: 'name', label: '货架名称', component: 'Input', colProps: { span: 12 } },
  { field: 'sortNo', label: '排序号', component: 'InputNumber', colProps: { span: 12 }, defaultValue: 0 },
  { field: 'status', label: '状态', component: 'JDictSelectTag', colProps: { span: 12 }, componentProps: { dictCode: 'yn', type: 'radioButton', stringToNumber: true }, defaultValue: 1 },
  { field: 'remark', label: '备注', component: 'InputTextArea', colProps: { span: 24 } },
];
