...
export const searchFormSchema: FormSchema[] = [
  ...
  { field: 'type', label: '库位类型', component: 'JDictSelectTag', colProps: { span: 6 }, componentProps: { dictCode: 'mes_location_type' } },
...
export const formSchema: FormSchema[] = [
  ...
  { field: 'code', label: '库位编码', component: 'Input', required: true, colProps: { span: 12 } },
  { field: 'name', label: '库位名称', component: 'Input', colProps: { span: 12 } },
  ...
  { field: 'area', label: '区域', component: 'Input', colProps: { span: 8 } },
  { field: 'passageRow', label: '通道行数', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'passageCol', label: '通道列数', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'shelfRow', label: '货架行数', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'shelfCol', label: '货架列数', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'maxCapacity', label: '最大容量', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'length', label: '长(cm)', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'width', label: '宽(cm)', component: 'InputNumber', colProps: { span: 8 } },
  { field: 'height', label: '高(cm)', component: 'InputNumber', colProps: { span: 8 } },
...
export const generateFormSchema: FormSchema[] = [
  { field: 'area', label: '区域', component: 'Input', required: true, colProps: { span: 24 }, help: '如: A' },
