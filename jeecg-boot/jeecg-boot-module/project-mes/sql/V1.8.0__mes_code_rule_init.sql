...
-- 初始化编码规则（INSERT IGNORE 幂等：已存在则跳过，不重置流水号）
INSERT IGNORE INTO c_mes_code_rule (id, rule_code, rule_name, prefix, date_format, seq_length, reset_cycle, current_seq, `current_date`, create_by, create_time, update_by, update_time, del_flag)
VALUES ('mes_code_rule_SO', 'SO', '销售订单编码', 'SO', 'yyyyMMdd', 4, 'DAILY', 0, NULL, 'admin', NOW(), 'admin', NOW(), 0);

INSERT IGNORE INTO c_mes_code_rule (id, rule_code, rule_name, prefix, date_format, seq_length, reset_cycle, current_seq, `current_date`, create_by, create_time, update_by, update_time, del_flag)
VALUES ('mes_code_rule_PO', 'PO', '采购订单编码', 'PO', 'yyyyMMdd', 4, 'DAILY', 0, NULL, 'admin', NOW(), 'admin', NOW(), 0);

INSERT IGNORE INTO c_mes_code_rule (id, rule_code, rule_name, prefix, date_format, seq_length, reset_cycle, current_seq, `current_date`, create_by, create_time, update_by, update_time, del_flag)
VALUES ('mes_code_rule_MO', 'MO', '生产订单编码', 'MO', 'yyyyMMdd', 4, 'DAILY', 0, NULL, 'admin', NOW(), 'admin', NOW(), 0);
