...
@Slf4j
@Tag(name = "MES-客户价格表")
@RequiresPermissions("mes:customerPrice:list")
@RestController
...
public class MesCustomerPriceController extends JeecgController<MesCustomerPrice, IMesCustomerPriceService> {
    ...
    @RequiresPermissions("mes:customerPrice:export")
    ...
    @RequiresPermissions("mes:customerPrice:import")
