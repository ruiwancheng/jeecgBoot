//update-begin---author:ruiwancheng---date:2026-07-10---for: MES客户模块升级-联系人管理接口-----------
...
public class MesCustomerContactController extends JeecgController<MesCustomerContact, IMesCustomerContactService> {
    ...
    public Result<IPage<MesCustomerContact>> queryPageList(MesCustomerContact entity,
        ...
        qw.eq(StrUtil.isNotBlank(entity.getCustomerId()), MesCustomerContact::getCustomerId, entity.getCustomerId());
...
//update-end---author:ruiwancheng---date:2026-07-10---for: MES客户模块升级-联系人管理接口-----------
