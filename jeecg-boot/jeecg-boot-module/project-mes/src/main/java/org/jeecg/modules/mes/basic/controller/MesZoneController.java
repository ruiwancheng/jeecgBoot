...
public class MesZoneController extends JeecgController<MesZone, IMesZoneService> {
    ...
    @PostMapping("/add") public Result<String> add(@RequestBody MesZone e) { service.save(e); return Result.ok("添加成功"); }
    @PutMapping("/edit") public Result<String> edit(@RequestBody MesZone e) { service.updateById(e); return Result.ok("编辑成功"); }
