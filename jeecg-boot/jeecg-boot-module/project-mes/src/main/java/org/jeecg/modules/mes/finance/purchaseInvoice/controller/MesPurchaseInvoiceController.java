...
public class MesPurchaseInvoiceController extends JeecgController<MesPurchaseInvoice, IMesPurchaseInvoiceService> {
    ...
    @PostMapping("/add") @RequiresPermissions("mes:purchaseInvoice:add") public Result<String> add(@RequestBody MesPurchaseInvoice e) { if (e == null) return Result.error("请求体不能为空"); service.save(e); return Result.ok("添加成功"); }
