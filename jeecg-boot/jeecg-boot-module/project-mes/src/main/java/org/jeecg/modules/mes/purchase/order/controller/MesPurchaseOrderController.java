//update-begin---author:ruiwancheng---date:2026-07-16---for: MES采购管理-采购订单接口-----------
package org.jeecg.modules.mes.purchase.order.controller;
...
public class MesPurchaseOrderController extends JeecgController<MesPurchaseOrder, IMesPurchaseOrderService> {
    @Autowired
    private IMesPurchaseOrderService service;
    ...
    public Result<IPage<MesPurchaseOrder>> queryPageList(MesPurchaseOrder entity,
            @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo,
            @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize, HttpServletRequest req) {
        QueryWrapper<MesPurchaseOrder> qw = QueryGenerator.initQueryWrapper(entity, req.getParameterMap());
    ...
    @RequiresPermissions("mes:purchaseOrder:list")
    public Result<MesPurchaseOrder> queryById(@RequestParam String id) {
        MesPurchaseOrder entity = service.queryWithItems(id);
    ...
    public Result<String> add(@RequestBody MesPurchaseOrder entity) { service.saveWithItems(entity); return Result.ok("添加成功"); }

    @Operation(summary = "编辑订单（含订单行）")
    @PutMapping("/edit")
    @RequiresPermissions("mes:purchaseOrder:edit")
    public Result<String> edit(@RequestBody MesPurchaseOrder entity) { service.updateWithItems(entity); return Result.ok("编辑成功"); }

    @Operation(summary = "删除订单")
    @DeleteMapping("/delete")
    @RequiresPermissions("mes:purchaseOrder:delete")
    public Result<String> delete(@RequestParam String id) { service.removeWithItems(id); return Result.ok("删除成功"); }

    @Operation(summary = "批量删除")
    @DeleteMapping("/deleteBatch")
    @RequiresPermissions("mes:purchaseOrder:deleteBatch")
    ...
    @GetMapping("/queryAll")
    @RequiresPermissions("mes:purchaseOrder:list")
    public Result<List<MesPurchaseOrder>> queryAll() {
    ...
    public ModelAndView exportXls(MesPurchaseOrder entity, HttpServletRequest req) {
