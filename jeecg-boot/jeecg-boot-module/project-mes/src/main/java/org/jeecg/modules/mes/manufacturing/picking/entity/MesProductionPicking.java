...
@TableName("c_mes_production_picking")
@Schema(description = "MES-生产领料")
public class MesProductionPicking implements Serializable {
    ...
    @Excel(name = "状态", width = 10, dicCode = "mes_picking_status") @Dict(dicCode = "mes_picking_status") private String status;
    ...
    private transient List<MesProductionPickingItem> items;
}
