...
INSERT INTO sys_permission SELECT 'cust_demo_wh_loc','','库位明细管理','/customer/demo/warehouse/location','customer/demo/warehouse/location',1,1,11.00,'ant-design:environment-filled',1,0,0,'1','admin',NOW()
