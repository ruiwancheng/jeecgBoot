// MES 批次库存 E2E 测试（/add-tests basic batchInventory）
// 覆盖：/project/mes/batch/inventory（只读 + 导出）
// 后端：GET /mes/batch/inventory/{list,queryById,exportXls}（无 add/edit/delete — 业务自动维护）
