...
> **复核结果** 留空，由业务人员手工填写并注明真实 BUG / 误判及原因。
...
> 业务人员复核「第四节·复核结果」：
> 1. 标注每条 failed 切片是 **真实 BUG** 还是 **误判**
> 2. 误判必须填写误判原因（如：dev DB 残留数据、测试期望过严、前端 UI 设计本就如此等）
> 3. 真实 BUG 标 severity (P0/P1/P2) + 跟进负责人
> 复核完成后报告回写本节「复核人 / 复核时间」
